...
#ifndef SPCPOINTHOME_SWIFT_H
#define SPCPOINTHOME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SPCPointHome",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12SPCPointHome22AvatyeWebSDKController")
@interface AvatyeWebSDKController : NSObject <WKScriptMessageHandler>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC12SPCPointHome19PHWebViewController")
@interface PHWebViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12SPCPointHome17PointHomeAdLoader")
@interface PointHomeAdLoader : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
